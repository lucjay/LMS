...
<body>
	...
	<div class="w3-top">
		<div class="w3-bar" id="myNavbar">
			<a
				...
				href="#members" class="w3-bar-item w3-button w3-hide-small"><i
				class="fa fa-user"></i> MEMBERS</a> <a href="#board"
				class="w3-bar-item w3-button w3-hide-small"><i class="fa fa-th"></i>
				BOARD</a> <a href="#join" class="w3-bar-item w3-button w3-hide-small"><i
				class="fa fa-envelope"></i> JOIN</a> <a href="#"
		...
		<div id="navDemo"
			...
			<a href="#members" class="w3-bar-item w3-button"
				onclick="toggleFunction()">MEMBERS</a> <a href="#board"
				class="w3-bar-item w3-button" onclick="toggleFunction()">BOARD</a> <a
				href="#join" class="w3-bar-item w3-button"
				onclick="toggleFunction()">JOIN</a> <a href="#"
	...
	<div class="bgimg-1 w3-display-container w3-opacity-min" id="home">
		<div class="w3-display-middle" style="white-space: nowrap;">
			<span
				class="w3-center w3-padding-large w3-black w3-xlarge w3-wide w3-animate-opacity">BINWOO
				<span class="w3-hide-small">WEBSITE</span> ♥
			</span>
		</div>
	</div>
	...
	<div class="w3-content w3-container w3-padding-64" id="members">
		<h3 class="w3-center">MEMBER LIST</h3>
		<p class="w3-center">
			<em>회원목록</em>
		</p>
		<div align="center">
	...
	<footer
		...
		<p>
			Powered by <a href="https://www.w3schools.com/w3css/default.asp"
				title="W3.CSS" target="_blank" class="w3-hover-text-green">binwoo.Lee</a>
		</p>
	</footer>
